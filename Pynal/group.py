...
class WeKpopApp:
    ...
    def create_labels(self):
        ...
        logo_image = logo_image.resize((300, 75))
        ...
        profile_image = Image.open("user.png")
        ...
        Label(self.root, text="Logout", font=("TW Cen MT", 16), bg="#343ab1", fg="white").place(x=1650, y=50)
        ...
        y_positions = [350, 350, 350, 650, 650, 650]
        ...
        for i, group in enumerate(groups):
            ...
            x_centered = x_positions[i] + (165 - image_width // 2)
    ...
    def run(self):
        ...
        Label(self.root, text="GROUPS", font=("Cooper Black", 30), fg="pink", bg="light yellow").place(x=130, y=180)
